...
const Modal = ({ openModal, closeModal, children }) => {
    ...
    return (
        <dialog ref={ref} onCancel={closeModal} className="backdrop:bg-black/25 rounded-xl p-0 border-none w-full max-w-md mx-auto my-auto">
            <div className="bg-background border-2 border-black dark:border-border rounded-xl shadow-xl text-content">
